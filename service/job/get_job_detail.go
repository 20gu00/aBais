...
// yaml
func (j *job) GetJobDetail(client *kubernetes.Clientset, configMapName, namespace string) (job *batchv1.Job, err error) {
	job, err = client.BatchV1().Jobs(namespace).Get(context.TODO(), configMapName, metav1.GetOptions{})
	if err != nil {
