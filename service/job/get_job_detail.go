...
// yaml
func (j *job) GetJobDetail(client *kubernetes.Clientset, cronJobName, namespace string) (job *batchv1.Job, err error) {
	job, err = client.BatchV1().Jobs(namespace).Get(context.TODO(), cronJobName, metav1.GetOptions{})
	if err != nil {
